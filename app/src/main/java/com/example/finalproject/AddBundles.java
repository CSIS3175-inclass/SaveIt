...
public class AddBundles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isInserted)
                {
                    Toast.makeText(AddBundles.this, "Bundle Added!", Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText(AddBundles.this, "Bundle not added", Toast.LENGTH_LONG).show();
                }

                startActivity(new Intent(AddBundles.this, HomeManagerActivity.class));
            }
        });
